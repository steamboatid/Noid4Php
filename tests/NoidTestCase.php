...
class NoidTestCase extends TestCase{
	...
	public function setUp()
	{
		...
		$this->cmd = is_executable(self::NOID_BIN) ? self::NOID_BIN : getcwd() . DIRECTORY_SEPARATOR . 'noid';
		$this->noid_dir = $this->dir . DIRECTORY_SEPARATOR . 'NOID' . DIRECTORY_SEPARATOR;

		require_once dirname($this->cmd) . DIRECTORY_SEPARATOR . 'Lib' . DIRECTORY_SEPARATOR . 'Noid.php';
	}
